...
document.addEventListener('DOMContentLoaded', function() {
	...
	// Vehicle Permit From Date
    $('.permit_fdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
		selectMonths: true,
    });
	
	// Vehicle Permit To Date
    $('.permit_tdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
		selectMonths: true,
    });
	
	// Vehicle Insurance From Date
    $('.insur_fdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
		selectMonths: true,
    });
	
	// Vehicle Insurance To Date
    $('.insur_tdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
        selectYears: 20,
		selectMonths: true,
	...
	// Vehicle Road Tax From Date
    $('.rtax_fdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
		selectMonths: true,
    });
	
	// Vehicle Road Tax To Date
    $('.rtax_tdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
		selectMonths: true,
    });
	
	// Vehicle Fitness From Date
    $('.fit_fdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
		selectMonths: true,
    ...
    $('.fit_tdate').pickadate({
     ...
     $('.vehicle_expense_date').pickadate({
        format:'dd-mm-yyyy',
        defaultDate : moment(),
        selectMonths: true,
    });

    $('.vehicle_expense_fdate').pickadate({
        format:'dd-mm-yyyy',
        selectMonths: true,
    });

     $('.vehicle_expense_tdate').pickadate({
        format:'dd-mm-yyyy',
        selectYears: 20,
        selectMonths: true,
    });
...
//add lead from dates
 $('.introduce_date').pickadate({
        format:'dd-mm-yyyy',
        selectMonths: true,
    });

  $('.approach_date').pickadate({
        format:'dd-mm-yyyy',
        selectMonths: true,
    });

  $('.business_date').pickadate({
        format:'dd-mm-yyyy',
        selectMonths: true,
    });
 ...
 $('.cp_dob').pickadate({
  ...
  // create Quotation dates
 $('.qt_date').pickadate({
        format:'dd-mm-yyyy',
        selectMonths: true,
    });
 $('.qt_expdate').pickadate({
        format:'dd-mm-yyyy',
        selectMonths: true,
    });
