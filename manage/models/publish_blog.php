...
{	
	...
	try
	{	
		$sql="UPDATE features SET $up_data WHERE id='$id';";
		$q=$conn->prepare($sql);
		if($q->execute($data))
		{
			if($st=="1")
			{
				$sqlchk="SELECT * FROM features WHERE id='$id';";
                ...
                $searchfor = "https://www.turnofspeed.in/feature/".$chk_res[0]['url_id'].".html";
                ...
                $sqlup="UPDATE features SET is_index='$status_code' WHERE id='$id';";
				...
				$_SESSION['s']="Feature Published Successfully !!!";
			}
			else
			{
				$_SESSION['s']="Feature Un-published Successfully !!!";
			}
			header('Location:'.ROOT_URL.'view_blog.php');
		}
		else
		{
			$_SESSION['e']="Failed To Published / Un-published Feature, Please Try Again !!!";
