...
{	
	...
	try
	{	
		$sql="UPDATE articles SET $up_data WHERE id='$id';";
		$q=$conn->prepare($sql);
		if($q->execute($data))
		{
			if($st=="1")
			{
				$sqlchk="SELECT * FROM articles WHERE id='$id';";
                ...
                $searchfor = "https://www.turnofspeed.in/article/".$chk_res[0]['url_id'].".html";
                ...
                $sqlup="UPDATE articles SET is_index='$status_code' WHERE id='$id';";
				...
				$_SESSION['s']="Blog Published Successfully !!!";
			}
			else
			{
				$_SESSION['s']="Blog Un-published Successfully !!!";
			}
			header('Location:'.ROOT_URL.'view_new_blog.php');
		}
		else
		{
			$_SESSION['e']="Failed To Published / Un-published Blog, Please Try Again !!!";
