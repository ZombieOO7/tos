					...
					<div class="page-header page-header-default">
						<div class="page-header-content">
							<div class="page-title">
								<h2 class="no-margin text-light">ADD ARTICLE</h2>
							</div>
						</div>
					</div>
					<div class="content">
							...
							<div class="col-md-12 col-sm-12">
								<div class="panel panel-flat">
									<div class="panel-body">
										<form action="<?=ROOT_URL;?>models/add_new_blog.php" method="post" class="validate-add-customer" enctype="multipart/form-data" id="add_new_blog">
											<div class="col-md-12 col-sm-12">
											...
											<div class="col-md-12 col-sm-12">
												<label for="blog_content">Article Content <span style="color:#F00;">*</span>:</label>
