					...
					<div class="page-header page-header-default">
						<div class="page-header-content">
							<div class="page-title">
								<h2 class="no-margin text-light">ADD FEATURE</h2>
							</div>
						</div>
					</div>
					<div class="content">
							...
							<div class="col-md-12 col-sm-12">
								<div class="panel panel-flat">
									<div class="panel-body">
										<form action="<?=ROOT_URL;?>models/add_blog.php" method="post" class="validate-add-customer" enctype="multipart/form-data" id="add_blog">
											<div class="col-md-12 col-sm-12">
												<div class="form-group">
													<label for="blog_name">Feature Heading <span style="color:#F00;">*</span>:</label>
													<input type="text" class="form-control" name="blog_name" id="blog_name" required>
												</div>
											</div>
											<div class="col-md-12 col-sm-12">
												<div class="form-group">
													<label for="blog_subhead">Feature Sub Head <span style="color:#F00;">*</span>:</label>
											...
											<div class="col-md-4 col-sm-12">
												<div class="form-group">
													<label for="blog_author">Feature Author <span style="color:#F00;">*</span>:</label>
													<input type="text" class="form-control" name="blog_author" id="blog_author" required>
												</div>
											</div>
											<div class="col-md-4 col-sm-12">
												<div class="form-group">
													<label for="blog_location">Feature Location <span style="color:#F00;">*</span>:</label>
											...
											<div class="col-md-5 col-sm-12">
												<div class="form-group">
													<label for="blog_date">Feature Date <span style="color:#F00;">*</span>:</label>
											...
											<div class="col-md-12 col-sm-12">
												<label for="blog_content">Feature Content <span style="color:#F00;">*</span>:</label>
