					...
					<div class="page-header page-header-default">
						<div class="page-header-content">
							<div class="page-title">
								<h2 class="no-margin text-light">EDIT REVIEW</h2>
							</div>
						</div>
					</div>
					<div class="content">
							...
							<div class="col-md-12 col-sm-12">
								<div class="panel panel-flat">
									<div class="panel-body">
										<form action="<?=ROOT_URL;?>models/edit_post.php" method="post" class="validate-add-customer" enctype="multipart/form-data" id="edit_post">
										<?php if(!empty($results)){ foreach ($results as $result) { ?>
											<input type="hidden" name="p_id" value="<?=$result['id']; ?>">
											<div class="col-md-12 col-sm-12">
												<div class="form-group">
													<label for="post_name">Review Heading <span style="color:#F00;">*</span>:</label>
													<input type="text" class="form-control" name="post_name" id="post_name" value="<?=$result['p_name']; ?>" required>
												</div>
											</div>
											<div class="col-md-12 col-sm-12">
												<div class="form-group">
													<label for="post_subhead">Review Sub Head <span style="color:#F00;">*</span>:</label>
													<input type="text" class="form-control" name="post_subhead" id="post_subhead" value="<?=$result['p_subhead']; ?>">
												</div>
											</div>
											...
											<div class="col-md-4 col-sm-12">
												<div class="form-group post">
													...
													<select name="cat_id" id="cat_id" class="form-control select-search" required>
														...
														<?php if(!empty($category)){ foreach($category as $cat){ if ($cat['id']==$result['p_cat_id']) { ?>
											...
											<div class="col-md-4 col-sm-12">
												<div class="form-group">
													...
													<input type="file" class="form-control file-upload" name="cover_file[]" id="cover_file" multiple>
												</div>
											</div>
											<div class="col-md-3 col-sm-12">		
												<div class="form-group">
													<label for="post_author">Review Author <span style="color:#F00;">*</span>:</label>
													<input type="text" class="form-control" name="post_author" id="post_author" value="<?=$result['p_author']; ?>" required>
												</div>
											</div>
											<div class="col-md-3 col-sm-12">
												<div class="form-group">
													<label for="post_location">Review Location <span style="color:#F00;">*</span>:</label>
													<input type="text" class="form-control" name="post_location" id="post_location" value="<?=$result['p_location']; ?>" required>
												</div>
											</div>
											<div class="col-md-3 col-sm-12">
												<div class="form-group">
													<label for="photo_credit">Photo Credit :</label>
													<input type="text" class="form-control" name="photo_credit" id="photo_credit" value="<?=$result['p_photo_credit']; ?>" >
												</div>
											</div>
											<div class="col-md-4 col-sm-12">
												<div class="form-group">
													<label for="illustration">Illustration :</label>
													<input type="text" class="form-control" name="illustration" id="illustration" value="<?=$result['p_illustration']; ?>">
												</div>
											</div>
											<div class="col-md-4 col-sm-12">
												<div class="form-group">
													<label for="graphics">Graphics :</label>
													<input type="text" class="form-control" name="graphics" id="graphics" value="<?=$result['p_graphics']; ?>">
												</div>
											</div>
											<div class="col-md-5 col-sm-12">
												<div class="form-group">
													<label for="post_date">Review Date <span style="color:#F00;">*</span>:</label>
													<input type="text" class="form-control a_date" name="post_date" id="post_date" placeholder="DD-MM-YYYY" value="<?=date('d-m-Y',strtotime($result['p_date'])); ?>" required>
												</div>
											</div>
											<div class="col-md-5 col-sm-12">
												<div class="form-group">
											...
											<div class="col-md-2 col-sm-12">
												<div class="form-group">
													<label for="post_comment">Comments Allowed <span style="color:#F00;">*</span>:</label><br>
													<input type="checkbox" class="switch" data-on-text="Yes" data-off-text="No" data-on-color="success" data-off-color="danger" name="post_comment" <?php if($result['comment']=="1"){echo "checked"; }else{} ?> >
												</div>
											</div>
											<div class="col-md-2 col-sm-12">
												<div class="form-group">
											...
											<div class="col-md-12 col-sm-12">
												...
												?>
												<textarea name="post_content"><?=$content; ?></textarea>
											</div>
											<div class="col-md-12 col-sm-12 mt-15" align="center">
												<div class="form-group ">
