					...
					<div class="page-header page-header-default">
						<div class="page-header-content">
							<div class="page-title">
								<h2 class="no-margin text-light">EDIT FEATURE</h2>
							</div>
						</div>
					</div>
					<div class="content">
							...
							<div class="col-md-12 col-sm-12">
								<div class="panel panel-flat">
									<div class="panel-body">
										<form action="<?=ROOT_URL;?>models/edit_blog.php" method="post" class="validate-add-customer" enctype="multipart/form-data" id="edit_blog">
										<?php if(!empty($results)){ foreach ($results as $result) { ?>
											...
											<div class="col-md-12 col-sm-12">
												...
												?>
												<textarea name="blog_content"><?=$content; ?></textarea>
											</div>
