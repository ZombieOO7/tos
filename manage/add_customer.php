					...
					<div class="page-header page-header-default">
						<div class="page-header-content">
							<div class="page-title">
								<h2 class="no-margin text-light">ADD CUSTOMER</h2>
							</div>
						</div>
					</div>
					<div class="content">
							...
							<div class="col-md-12 col-sm-12">
								<div class="panel panel-flat">
									<div class="panel-body">
										<form action="<?=ROOT_URL;?>models/add_customer.php" method="post" class="validate-add-customer" enctype="multipart/form-data" id="add_cust">
											<div class="col-md-6 col-sm-6">
												<div class="form-group ">
													<label for="cust_name">Customer Name <span style="color:#FF0000;">*</span>:</label>
													<input type="text" class="form-control" name="cust_name" id="cust_name"  placeholder="First & Last Name" required>
												</div>
												<div class="form-group ">
													<label for="cust_phone">Phone No <span style="color:#FF0000;">*</span>:</label>
													<input type="text" class="form-control" name="cust_phone" id="cust_phone"  placeholder="9999999999" required>
												</div>
												<div class="form-group ">
													<label for="cust_email">Email Id <span style="color:#FF0000;">*</span>:</label>
													<input type="email" class="form-control" name="cust_email" id="cust_email"  placeholder="Enter Customer Email" autocomplete="off" required>
												</div>
											</div>
											<div class="col-md-6 col-sm-6">
												<div class="form-group ">
													<label for="cust_pass">Enter Password <span style="color:#FF0000;">*</span>:</label>
													<input type="password" class="form-control" name="cust_pass" id="cust_pass" placeholder="Enter Password" autocomplete="off" required>
												</div>
												<div class="form-group ">
