...
$new_blog=$query_db->fetchAll(PDO::FETCH_ASSOC);
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-8">
					<h4 class="mag-widget-title-1">Columns</h4>
					<hr>
					<?php if(!empty($new_blog)){ foreach($new_blog as $blg){ ?>
					<div class="timeline-container relative">
						<span class="timeline-bar hidden-xs"></span>
							<article class="hentry-timeline hentry-card mb-40">
								<time class="date-time gray-bg-3">
									<span class="datetime-holder roboto-slab">
										<span class="day title-color f700"><?=date("d",strtotime($blg['b_date'])); ?></span>
										<span style="color:#000;" class="month fw300 fz-15"><?=date("M",strtotime($blg['b_date'])); ?></span>
                                        <span style="color:#000;" class="month fw300 fz-11"><?=date("Y",strtotime($blg['b_date'])); ?></span>
									</span>
								</time>
								<div class="div-card">
									...
									<div class="overlap-top-20 relative">
										<header class="hentry-header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
											<h3><a href="<?=ROOT_URL_FRONT."column/".$blg['url_id'].".html"; ?>"><?=$blg['b_name']; ?></a></h3>
										</header>
